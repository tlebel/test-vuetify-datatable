  ...
  methods: {
    ...
    save () {
      if (this.editedIndex > -1) {
        this.$set(this.desserts, this.editedIndex, this.editedItem)
      } else {
    ...
    <v-row class="text-center">
      <v-col cols="12">
        <v-data-table
          ...
          :items="desserts"
          :footer-props="{
            itemsPerPageOptions: [5, 10, 100, 250]
          }"
          class="elevation-1"
        >
          <template v-slot:top>
            <v-toolbar
              flat
            >
              <v-toolbar-title>My CRUD - with Non-Reactive items object</v-toolbar-title>
              <v-divider
                class="mx-4"
                inset
                vertical
